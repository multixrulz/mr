...
// Sounds to play
audio_correct = new Audio('/jquiz/media/applause_normal.mp3');
audio_incorrect = new Audio('/jquiz/media/336998__timkahn__awww-01.mp3');
audio_music = new Audio('/jquiz/media/sport-news-intro-01-by-taigasoundprod-from-filmmusic-io.mp3');
 ...
 */
    // TODO: Implement max_questions random feature
    // Get the file
    ...
    // Create a container for the unique quiz
